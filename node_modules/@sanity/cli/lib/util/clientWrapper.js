...
const authErrors = () => ({
  onError: err => {
    ...
    if (statusCode === 401) {
      err.message = `${err.message}. You may need to login again with ${_chalk.default.cyan('sanity login')}.\nFor more information, see ${(0, _generateHelpUrl.generateHelpUrl)('cli-errors')}.`;
    }
    return err;
  }
});
