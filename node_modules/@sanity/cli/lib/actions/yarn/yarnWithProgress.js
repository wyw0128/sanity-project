...
function yarnWithProgress(args, options = {}) {
  ...
  const nodeArgs = [yarnPath].concat(args, ['--json', '--non-interactive', '--ignore-engines', '--network-timeout', '60000', '--registry', 'https://registry.npmjs.org']);
  const state = {
  ...
  const throttledOnProgressTick = (0, _lodash.throttle)(onProgressTick, 50);
