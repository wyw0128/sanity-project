...
const datasetNameError = 'Dataset names can only contain lowercase characters,' + 'numbers, underscores and dashes' + `and can be at most ${MAX_DATASET_NAME_LENGTH} characters.`;
